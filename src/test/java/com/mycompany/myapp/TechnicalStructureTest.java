...
@AnalyzeClasses(packagesOf = JhipsterMicroService1App.class, importOptions = DoNotIncludeTests.class)
class TechnicalStructureTest {
    ...
    static final ArchRule respectsTechnicalArchitectureLayers = layeredArchitecture()
        ...
        .ignoreDependency(belongToAnyOf(JhipsterMicroService1App.class), alwaysTrue())
